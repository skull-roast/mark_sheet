...
let obtainedMarks = marks.english + marks.physics + marks.islamiyat + marks.physics + marks.science;
let obtainedPercentage = Math.round(obtainedMarks / totalMarks * 100);
